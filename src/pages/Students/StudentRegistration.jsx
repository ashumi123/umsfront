    ...
    <div className="bg-gray-50 min-h-screen p-4 sm:p-8 font-sans">
      <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-2xl p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <SectionHeader title="5. Current Program Subject Marks" color="bg-indigo-50" textColor="text-indigo-700" />
          <div className="p-4 border border-indigo-200 rounded-b-lg space-y-4">
